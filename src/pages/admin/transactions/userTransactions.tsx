...
const UserTransactions = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    dispatch(transactionActions.getAdminTransactions(1))
  }, [location]);
          ...
          },
          {
            ...
            handleClick: () => {
              if (from !== to) {
                ...
                dispatch(transactionActions.transferDonuts(from, to, amount, 1));
              }
            }
          }
        ]}
                ...
                {transactionList.map((transaction: any, index: any) => (
                  <tr key={index}>
                    ...
                    <td>
                      ...
                      {transaction.description === 3 && `Vote Donut x1 for Free`}
                    ...
                    <td>
                      <div className="donuts-type">
                        <CreatoCoinIcon color={calcColor(1, transaction.description, transaction.to) ? "#27AE60" : "#AE0000"} />
                        <span style={calcColor(1, transaction.description, transaction.to) ? { color: '#27AE60' } : { color: '#AE0000' }}>
